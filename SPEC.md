...
So the backdrop is the same real city boundary the city overview draws — `GET /static/<slug>/city.geojson`, projected and rendered as inline SVG — cropped to the screen and fogged with the application's own ink at a single low alpha.
