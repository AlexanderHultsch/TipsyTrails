...
- [ ] `GUARD 3: Web/WebViewController.swift routes exactly the Page → shell message types of 8.2` — `packages/tracker/src/ios-swift.test.ts`, checked against `Web/WebViewController.swift` and `Screens/ConsentScreen.swift`
