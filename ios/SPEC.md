...
**Parent:** `SPEC.md` at the repository root, v1.65. This document does not replace it and cannot contradict it; Section 14 here lists the amendments the parent needs before this one is in force.
